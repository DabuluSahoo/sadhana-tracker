                    ...
                    <div className="max-w-md w-full bg-white rounded-xl shadow-xl overflow-hidden md:max-w-lg border border-saffron-100">
                        ...
                        <form onSubmit={handleSubmit} className="py-8 px-8 space-y-6">
                            ...
                            <div className="text-center mt-2">
                                <Link to="/forgot-password" className="text-sm text-saffron-700 hover:underline">
                                    Forgot Password?
                                </Link>
                            </div>
                            ...
                            <div className="text-center mt-2">
                                <p className="text-sm text-gray-600">
                                    ...
                                    <Link to="/register" className="font-medium text-saffron-700 hover:text-saffron-600">
                                        Register here
                                    </Link>
                                </p>
                            </div>
